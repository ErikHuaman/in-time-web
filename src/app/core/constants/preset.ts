    ...
    colorScheme: {
      light: {
        ...
        formField: {
          ...
          floatLabelInvalidColor: '{formField.invalid.placeholder.color}',
  ...
  components: {
    ...
    autocomplete: {
      root: {
        ...
        disabledBackground: '{formField.disabled.background}',
        filledBackground: '{formField.filled.background}',
        filledHoverBackground: '{formField.filled.hover.background}',
        filledFocusBackground: '{formField.filled.focus.background}',
        ...
        invalidBorderColor: '{formField.invalid.border.color}',
        color: '{formField.color}',
        disabledColor: '{formField.disabled.color}',
        placeholderColor: '{formField.placeholder.color}',
        invalidPlaceholderColor: '{formField.invalid.placeholder.color}',
        shadow: '{formField.shadow}',
        paddingX: '{formField.paddingX}',
        paddingY: '{formField.paddingY}',
        borderRadius: '{formField.border.radius}',
        focusRing: {
          width: '{formField.focus.ring.width}',
          style: '{formField.focus.ring.style}',
          color: '{formField.focus.ring.color}',
          offset: '{formField.focus.ring.offset}',
          shadow: '{formField.focus.ring.shadow}',
        },
      ...
      dropdown: {
        ...
        borderColor: '{formField.border.color}',
        hoverBorderColor: '{formField.border.color}',
        activeBorderColor: '{formField.border.color}',
        borderRadius: '{formField.border.radius}',
        focusRing: {
          width: '{focus.ring.width}',
          style: '{focus.ring.style}',
    ...
    checkbox: {
      root: {
        ...
        borderColor: '{formField.border.color}',
        hoverBorderColor: '{formField.hover.border.color}',
        focusBorderColor: '{formField.border.color}',
        checkedBorderColor: '{primary.color}',
        checkedHoverBorderColor: '{primary.hover.color}',
        checkedFocusBorderColor: '{primary.color}',
        checkedDisabledBorderColor: '{formField.border.color}',
        invalidBorderColor: '{formField.invalid.border.color}',
        shadow: '{formField.shadow}',
        focusRing: {
          width: '{focus.ring.width}',
    ...
    iftalabel: {
      root: {
        color: '{formField.float.label.color}',
        focusColor: '{formField.float.label.focus.color}',
        invalidColor: '{formField.float.label.invalid.color}',
        transitionDuration: '0.2s',
    ...
    floatlabel: {
      root: {
        color: '{formField.float.label.color}',
        focusColor: '{formField.float.label.focus.color}',
        activeColor: '{formField.float.label.active.color}',
        invalidColor: '{formField.float.label.invalid.color}',
        transitionDuration: '0.2s',
        positionX: '{formField.paddingX}',
    ...
    togglebutton: {
      root: {
        ...
        fontWeight: '500',
        disabledBackground: '{formField.disabled.background}',
        disabledBorderColor: '{formField.disabled.background}',
        disabledColor: '{formField.disabled.color}',
        invalidBorderColor: '{formField.invalid.border.color}',
        focusRing: {
          width: '{focus.ring.width}',
    ...
    toggleswitch: {
      ...
      colorScheme: {
        light: {
          ...
          handle: {
            background: '{surface.50}',
            disabledBackground: '{formField.disabled.color}',
            hoverBackground: '{surface.50}',
            checkedBackground: '{surface.50}',
